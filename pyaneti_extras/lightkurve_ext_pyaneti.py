...
# Use case: need to use SAP_FLUX to get extra transits
...
def plot_transit_at_epoch(
    ...
    if plot_fold and plot_kwargs.get('c') is None:
        # for phase folded plot, default to use the original time as the color,
        # so that one could check to see if the dips change over time.
